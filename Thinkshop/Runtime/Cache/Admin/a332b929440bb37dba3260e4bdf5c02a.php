...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="/thinkphp/thinkshop/Thinkshop/Admin/View/Public/css/style.css">
    <script src="/thinkphp/thinkshop/Thinkshop/Admin/View/Public/js/jquery.min.js"></script> 
</head>
<body>
    <div id="houtai">
        <div class="title">后台管理</div>
        <div class="form">
        <form action="/thinkphp/thinkshop/index.php/Admin/Login/login" name="form1" method="post">
            <table>
                <tr><td>账号：</td></tr>
    ...
    <script type="text/javascript">
        $(function() {
            $('input[type=text]').bind('blur',function() {
                ...
                var url='/thinkphp/thinkshop/index.php/Admin/Login/login';
                $.ajax({
                    url:url,
                    type:'get',
                    data:data,
